    ...
    <header class="main-header">
      ...
      <div class="header-top fl-wrap">
        <div class="container">
          ...
          <a href="dashboard-add-listing.html" class="add-hotel">
            Add Your Hotel
            <span>
          ...
          <div class="lang-wrap">
            ...
            <ul class="lang-tooltip green-bg">
              <li>
                <a href="#">
                  <img src="images/lan/4.png" alt /> De
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="images/lan/5.png" alt /> It
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="images/lan/2.png" alt /> Fr
                </a>
              </li>
              <li>
                <a href="#">
                  <img src="images/lan/3.png" alt /> Es
                </a>
              </li>
            </ul>
          </div>
          <div class="currency-wrap">
            ...
            <ul class="currency-tooltip">
              <li>
                <a href="#">
                  <i class="far fa-euro-sign"></i> EUR
                </a>
              </li>
              <li>
                <a href="#">
                  <i class="far fa-pound-sign"></i> GBP
                </a>
              </li>
              <li>
                <a href="#">
                  <i class="far fa-ruble-sign"></i>RUR
                </a>
              </li>
            </ul>
          </div>
                ...
                <ul>
                  <li class="clearfix">
                    <a href="#" class="widget-posts-img">
                      <img src="images/gal/1.jpg" class="respimg" alt />
                    </a>
                    <div class="widget-posts-descr">
                      ...
                      <div class="geodir-category-location fl-wrap">
                        <a href="#">
                          <i class="fas fa-map-marker-alt"></i> 40 JOURNAL SQUARE PLAZA, NJ, US
                        </a>
                      </div>
                  ...
                  <li class="clearfix">
                    ...
                    <div class="widget-posts-descr">
                      ...
                      <div class="geodir-category-location fl-wrap">
                        <a href="#">
                          <i class="fas fa-map-marker-alt"></i> 75 PRINCE ST, NY, USA
                        </a>
                      </div>
                      <span class="rooms-price">
                        $50
                  ...
                  <li class="clearfix">
                    ...
                    <div class="widget-posts-descr">
                      ...
                      <div class="geodir-category-location fl-wrap">
                        <a href="#">
                          <i class="fas fa-map-marker-alt"></i> 70 BRIGHT ST NEW YORK, USA
                        </a>
                      </div>
                      <span class="rooms-price">
                        $105
    ...
    <div id="wrapper">
      ...
      <div class="content">
            ...
            <div class="container">
              ...
              <div class="main-search-input-wrap">
                <div class="main-search-input fl-wrap">
                  ...
                  <button
                    class="main-search-button color2-bg"
        ...
        <section id="sec2">
          ...
          <!-- portfolio end -->
          <a href="listing.html" class="btn color-bg">
            Explore All Cities
                        ...
                        <div class="geodir-category-content-title-item">
                          ...
                          <div class="geodir-category-location fl-wrap">
                            <a href="#" class="map-item">
                              <i class="fas fa-map-marker-alt"></i> 27th Brooklyn New York, USA
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="geodir-category-footer fl-wrap">
                        ...
                        <div class="geodir-opt-list">
                          ...
                          <a href="#" class="geodir-js-booking">
                            ...
                            <span class="geodir-opt-tooltip">Find Directions</span>
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="geodir-category-content fl-wrap title-sin_item">
                      <div class="geodir-category-content-title fl-wrap">
                        <div class="geodir-category-content-title-item">
                          ...
                          <div class="geodir-category-location fl-wrap">
                            <a href="#" class="map-item">
                              <i class="fas fa-map-marker-alt"></i>40 Journal Square Plaza, NJ, USA
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="geodir-category-content fl-wrap title-sin_item">
                      <div class="geodir-category-content-title fl-wrap">
                        <div class="geodir-category-content-title-item">
                          ...
                          <div class="geodir-category-location fl-wrap">
                            <a href="#" class="map-item">
                              <i class="fas fa-map-marker-alt"></i> 34-42 Montgomery St , NY, USA
                            </a>
                          </div>
                        </div>
                      </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="colomn-text fl-wrap pad-top-column-text_small">
                  <div class="colomn-text-title">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.</p>
                    <a href="listing.html" class="btn color2-bg float-btn">
                      View All Hotels
                      <i class="fas fa-caret-right"></i>
                    </a>
                  </div>
              ...
              <div class="col-md-8">
                ...
                <div class="light-carousel-wrap fl-wrap">
                  ...
                  <!--light-carousel end-->
                  <div class="fc-cont lc-prev">
                    <i class="fal fa-angle-left"></i>
                  </div>
                  <div class="fc-cont lc-next">
              ...
              <div class="col-md-6">
                ...
                <div class="colomn-text pad-top-column-text fl-wrap">
                  <div class="colomn-text-title">
                    ...
                    <a href="#" class="down-btn color3-bg">
                      <i class="fab fa-apple"></i> Download for iPhone
                    </a>
                    <a href="#" class="down-btn color3-bg">
              ...
              <div class="col-md-8">
                ...
                <div class="colomn-text fl-wrap">
                  <div class="colomn-text-title">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.</p>
                    <a href="dashboard-add-listing.html" class="btn color-bg float-btn">
                      Add your hotel
        ...
        <section class="middle-padding">
          <div class="container">
              ...
              <div class="col-md-4">
                <article class="card-post">
                  ...
                  <div class="card-post-content fl-wrap">
                    <h3>
                      <a href="blog-single.html">Blog Post Title.</a>
                    </h3>
            ...
            <a href="blog.html" class="btn color-bg">
              Read All News
              <i class="fas fa-caret-right"></i>
            </a>
          </div>
      ...
      <div class="footer-inner">
        <div class="container">
              ...
              <div class="footer-widget fl-wrap">
                ...
                <div class="footer-contacts-widget fl-wrap">
                  ...
                  <ul class="footer-contacts fl-wrap">
                    ...
                    <li>
                      <span>
                        <i class="fal fa-map-marker-alt"></i> Adress :
                      </span>
          ...
          <div class="footer-widget">
            <div class="row">
              <div class="col-md-4">
                <a class="contact-btn color-bg" href="contacts.html">
                  Get In Touch
              ...
              <div class="col-md-8">
                <div class="customer-support-widget fl-wrap">
                  ...
                  <a href="tel:+19012300888" class="cs-mumber-button color2-bg">
                    Call Now
