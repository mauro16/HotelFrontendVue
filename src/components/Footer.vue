  ...
  <div>
    <footer class="main-footer">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="subscribe-header">
                <h3>Subscribe</h3>
                <p>Want to be notified when we have a new hotel or a new Deal. Just sign up and we'll send you a notification by email.</p>
              </div>
            </div>
      ...
      <div class="footer-inner">
        <div class="container">
          ...
          <div class="footer-widget">
            <div class="row">
              <div class="col-md-4">
                <a class="contact-btn color-bg" href="contact.html">
                  Get In Touch
              ...
              <div class="col-md-8">
                <div class="customer-support-widget fl-wrap">
                  ...
                  <a href="tel:+49-123456789" class="cs-mumber">+49(000)12345789</a>
                  <a href="tel:+49-123456789" class="cs-mumber-button color2-bg">
                    Call Now
      ...
      <div class="sub-footer">
        <div class="container">
          <div class="copyright">&#169; Flamingo Hotel Reservation - 2020 . All rights reserved.</div>
